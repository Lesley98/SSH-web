											...
											<TBODY>
												...
												<c:forEach items="${list }" var="visit">
													<TR
														...
														<td><a href="${pageContext.request.contextPath }/visit_showVisit.action?vid=${visit.vid}">修改</a></td>
														<td><a href="${pageContext.request.contextPath }/visit_delete.action?vid=${visit.vid}">删除</a></td>
													</TR>
