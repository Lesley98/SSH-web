				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：客户管理 &gt; 分页显示客户列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
										...
										<TABLE id=grid
											...
											<TBODY>
												<TR
													...
													/customer_delete.action?cid=<s:property value="#cus.cid"/>">删除</a></TD>
													<TD><a href="${pageContext.request.contextPath}
													/customer_showCustomer.action?cid=<s:property value="#cus.cid"/>">修改</a></TD>
													</TR>
												</c:forEach>
											</TBODY>
										</TABLE>
